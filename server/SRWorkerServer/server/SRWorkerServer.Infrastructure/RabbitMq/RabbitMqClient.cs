...
public class RabbitMqClient : IMessageClient, IDisposable
{
    ...
    private readonly IExchangeDictionaryService _dictionaryService;
    private readonly StringComparer _comparer;

    public RabbitMqClient(ILogger<RabbitMqClient> logger, IConnection connection, IOptionsMonitor<ClientSettings> options, IExchangeDictionaryService dictionaryService){
        _logger = logger;
    ...
    private void DeclareNecessary(){
        ExchangeWithQueues(_pixelOptions.ExchangeName, _pixelOptions.QueueNames, _pixelOptions.Tag);
    }
